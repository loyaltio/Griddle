...
var Griddle = function (_Component) {
  ...
  function Griddle(props) {
    ...
    var _props$plugins = props.plugins,
        ...
        userInitialState = _objectWithoutProperties(props, ['plugins', 'data', 'children', 'events', 'sortProperties', 'styleConfig', 'pageProperties', 'components', 'renderProperties', 'settingsComponentObjects', 'storeKey']);
